<template>
    <div>
        <div style="display: flex; justify-content: space-between">
            ...
            <el-button icon="el-icon-refresh" type="success" size="small"></el-button>
        </div>
        <div style="margin-top: 10px">
            ...
            <el-dialog
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button @click="preStep" size="small">{{activeItemIndex == 9 ? "取消" : "上一步"}}</el-button>
                    <el-button type="primary" size="small" @click="nextStep">{{activeItemIndex == 9 ? "完成" : "下一步"}}</el-button>
                </span>
            </el-dialog>
        </div>
    </div>
